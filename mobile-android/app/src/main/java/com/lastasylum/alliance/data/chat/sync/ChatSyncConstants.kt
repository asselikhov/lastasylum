...
internal const val CHAT_ACTIVE_ROOM_RECONCILE_INTERVAL_MS = 120_000L
internal const val CHAT_BACKGROUND_MESSAGE_REFRESH_DEFER_MS = 400L
internal const val CHAT_UNREAD_SYNC_DEBOUNCE_MS = 450L
