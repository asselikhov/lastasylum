...
object ChatSessionCache {
    /** In-memory reuse between overlay open/close and tab switches (disk backs longer retention). */
    private const val ROOMS_TTL_MS = 30 * 60_000L
    private const val MESSAGES_TTL_MS = 30 * 60_000L
